...
function loadCart() {
  ...
  if (products) {
    document.getElementById("cart-count").textContent = products.reduce(
    ...
    cartItem.innerHTML = `
      ...
      <td class="action-icons">
          <div class="quantity-controls">
              <button type="button" class="quantity-btn" onclick="changeQuantity(${
                item.id
              }, 'minus')">-</button>
...
function onPurchase() {
  ...
  if (window.Evergage) {
    ...
    console.log("Evergage Purchase event fired:", {
      orderId,
      totalValue,
      lineItems,
    });
